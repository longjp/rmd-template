...
library(ggrepel)
## simulate data
log2foldChange <- c(runif(50,min=-6,6),
                    runif(950,min=-3,3))
res <- data.frame(gene=paste0("gene",1:1000),
                  pvalue=c(rexp(50,rate=1000),runif(950)),
...
p <- ggplot(res,aes(x=log2foldChange,y=-log10(padj),label=delabel)) +
  geom_point() +
